package com.example.lfy.basicframes.view.drawerlayout;
...
import com.example.lfy.basicframes.utill.ScreenUtils;
import com.example.lfy.basicframes.utill.SizeUtils;
...
public class SlidingView extends HorizontalScrollView {
    ...
    */
    private void getAttrValue(AttributeSet attrs) {
        ...
        mMenuRightPadding = (int) ta.getDimension(R.styleable.SlidingView_menu_right_padding, SizeUtils.dp2px(DEFAULT_MENU_RIGHTPADDING));
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                if(isMenuOpened){
                    //判断点击的位置是否在contentview上   是的话则消耗事件
